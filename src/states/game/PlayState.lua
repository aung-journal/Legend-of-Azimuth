...
function PlayState:updateCamera()
    ...
    self.camX = math.max(0, math.min(TILE_SIZE * self.place.tileMap.width - VIRTUAL_WIDTH, targetX))
    self.camY = math.max(0, math.min(TILE_SIZE * self.place.tileMap.height - VIRTUAL_HEIGHT, targetY))
end